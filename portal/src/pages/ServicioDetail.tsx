...
const mockServicio: Service & { pianoName: string; technicianName: string } = {
  ...
  technicalNotes: 'Próxima afinación recomendada en 6 meses. Considerar regulación del mecanismo en la próxima visita.',
          ...
          <div className="card p-6">
            ...
            {servicio.rating ? (
              <div className="text-center">
                ...
                {servicio.rating.comment && (
                  <p className="text-gray-600 text-sm mt-3 italic">
                    "{servicio.rating.comment}"
                  </p>
                )}
                <p className="text-xs text-gray-400 mt-2">
                  Valorado el {new Date(servicio.rating.createdAt).toLocaleDateString('es-ES')}
                </p>
              </div>
            ) : (
              <div className="text-center">

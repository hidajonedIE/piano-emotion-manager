...
import type { purchaseOrderStatusEnum } from '../../drizzle/inventory-schema.js';
...
export function usePurchaseOrders(options: { pageSize?: number } = {}) {
  ...
  const updateOrderStatus = useCallback(async (orderId: number, status: purchaseOrderStatusEnum) => {

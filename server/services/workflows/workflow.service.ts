...
export class WorkflowService {
  ...
  async createWorkflow(
    ...
    const result = await (await getDb())!.insert('workflows' as never).values(workflow as never);
  ...
  private async createExecution(workflow: Workflow, context: WorkflowContext): Promise<WorkflowExecution> {
    ...
    const result = await (await getDb())!.insert('workflowExecutions' as never).values(execution as never);
  ...
  private async executeCreateTask(config: TaskActionConfig, context: WorkflowContext): Promise<ActionResult> {
    ...
    await (await getDb())!.insert('tasks' as never).values(task as never);
  ...
  private async executeCreateReminder(config: ReminderActionConfig, context: WorkflowContext): Promise<ActionResult> {
    ...
    await (await getDb())!.insert('scheduledReminders' as never).values(reminder as never);
  ...
  private async logAction(
    ...
    await (await getDb())!.insert('workflowActionLogs' as never).values(log as never);
  }

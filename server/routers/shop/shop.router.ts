...
export type ShopRouter = typeof shopRouter;
  ...
  // ============================================================================
  // ADMIN: Inicializar tienda
  // ============================================================================
  initializePlatformShop: protectedProcedure.mutation(async ({ ctx }) => {
    const db = await getDb();
    const { shops, shopTiers, shopRoles } = await import('../../../drizzle/shop-schema.js');

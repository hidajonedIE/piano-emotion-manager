...
const ProductFormModal: React.FC<ProductFormModalProps> = ({
  ...
  const categories: ProductCategory[] = [
    'strings', 'tuning_pins', 'hammers', 'dampers', 'keys',
    'action_parts', 'felts', 'tuning_tools', 'consumables', 'other'
  ];

  const types: ProductType[] = ['spare_part', 'tool', 'consumable', 'accessory', 'other'];

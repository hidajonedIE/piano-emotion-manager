 ...
 * Tipos de licencia
 */
export const licenseTypeValues = ['trial', 'free', 'starter', 'professional', 'enterprise'];
/**
 * Estados de licencia
 */
export const licenseStatusValues = ['available', 'active', 'expired', 'revoked', 'suspended'];
// ============================================================================
// Platform Admins
// ============================================================================
/**
...
export const platformAdmins = mysqlTable('platform_admins', {
    ...
    permissions: json('permissions').$type(), // Permisos específicos
...
export const licenses = mysqlTable('licenses', {
    ...
    metadata: json('metadata').$type(), // Datos adicionales

...
export const modules = mysqlTable('modules', {
  ...
  // Tipo y disponibilidad - usando los 3 niveles de suscripción
...
export type ModuleType = 'free' | 'professional' | 'premium';

 ...
 */
import { pgTable, serial, varchar, text, integer, decimal, boolean, timestamp, pgEnum, uniqueIndex, index, json, } from 'drizzle-orm/pg-core';
...
export const products = pgTable('products', {
    ...
    documentUrls: json('document_urls').$type(),
    // Compatibilidad con pianos
    compatibleBrands: json('compatible_brands').$type(),
    compatibleModels: json('compatible_models').$type(),
    // Notas y metadatos
    notes: text('notes'),
    tags: json('tags').$type(),
...
export const suppliers = pgTable('suppliers', {
    ...
    productCategories: json('product_categories').$type(),
    // Notas
    notes: text('notes'),
    // Estado
    isActive: boolean('is_active').notNull().default(true),

...
export const organizations = mysqlTable("organizations", {
    ...
    workingDays: json("workingDays").$type().default([1, 2, 3, 4, 5]), // 0=Dom, 1=Lun...
...
export const organizationMembers = mysqlTable("organization_members", {
    ...
    workingDays: json("workingDays").$type(), // Override org settings
    // Zonas/territorios asignados
    assignedZones: json("assignedZones").$type(), // Códigos postales, ciudades, etc.
    // Especialidades
    specialties: json("specialties").$type(), // Tipos de servicio especializados
    // Fechas
...
export const serviceZones = mysqlTable("service_zones", {
    ...
    postalCodes: json("postalCodes").$type(), // Lista de códigos postales
    cities: json("cities").$type(), // Lista de ciudades

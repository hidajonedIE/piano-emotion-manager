 ...
 */
import { mysqlTable, int, varchar, text, decimal, tinyint, timestamp, json, index, uniqueIndex, } from 'drizzle-orm/mysql-core';
import { relations } from 'drizzle-orm';
// ============================================================================
// Enums y Constantes
// ============================================================================
export const CLIENT_STATUSES = ['lead', 'prospect', 'active', 'inactive', 'churned'];
export const CLIENT_SOURCES = ['website', 'referral', 'social_media', 'email', 'phone', 'event', 'other'];
export const COMMUNICATION_TYPES = ['email', 'phone', 'sms', 'meeting', 'note'];
export const CAMPAIGN_TYPES = ['email', 'sms', 'notification'];
export const CAMPAIGN_STATUSES = ['draft', 'scheduled', 'running', 'completed', 'cancelled'];
// ============================================================================
// Tablas
// ============================================================================
/**
